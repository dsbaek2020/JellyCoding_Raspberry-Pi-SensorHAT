...
# saved as "/home/pi/sensor_menu-2021-02-03-10-47-07.py"
...
class temp(object):
    def __init__(self):
        ...
        self.tempMax = 50
        self.dotMax = 8
        self.scale = self.dotMax/self.tempMax
        
    def get_temp(self):
        self.temp = hat.get_temperature()
    ...
    def show_barGraph(self):
        ...
        #5
        #dx = 40, dy = 8
        #scale = dy/dx = 8/40 = 0.2
        
        #y = Numofdot
        #y = f(x) = scale*temp + 0
        numOfdot = int(self.scale * self.temp)
        for i in range(numOfdot):
            hat.set_pixel(self.x, 7-i, self.barColor)
